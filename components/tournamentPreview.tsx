...
export const TournamentPreviewView = (props: { tournament: Tournament }) => {
  ...
  return (
    <div className="mx-auto rounded-sm shadow-lg overflow-hidden border border-gray-200 cursor-pointer" onClick={() => router.push(`/tournaments/${tournament.documentId}`)}>
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="mt-2 flex flex-col gap-1 text-sm text-gray-600">
          ...
          <div className="flex items-center gap-1">
            ...
            <DateRangeComponent startDate={tournament.startDate} endDate={tournament.endDate} />
          </div>
        </div>
      </div>
    </div>
